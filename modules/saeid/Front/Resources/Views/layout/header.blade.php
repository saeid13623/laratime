        ...
        <div class="t-header-row">
            ...
            <div class="t-header-left">
                ...
                <div class="join-teachers">
                    <a href="become-a-teacher.html">تدریس در سایت</a>
                </div>
                @auth()
                    <div class="user-menu-account">
                        <div class="user-image">
                            <img src="{{ auth()->user()->thumb }}" alt="desction">
                        </div>
                        ...
                        <div class="user-menu-account-dropdown">
                            <ul>
                                ...
                                <form action="{{route('logout')}}" method="post">
                                    ...
                                    <button class="btn-login">خروج</button>
                                </form>
    ...
    <nav id="navigation" class="navigation">
        ...
        <div class="container">
            <ul class="nav">
                ...
                <li class="main-menu {{ count($category->subParentCategory) ? 'has-sub' : '' }}"><a href="{{--{{$category->path()}}--}}">{{ $category->title }}</a>
                    @if(count($category->subParentCategory))
                    <div class="sub-menu">
                        <div class="container">
                            @foreach($category->subParentCategory as $subCategory)
                                <div><a href="android.html">{{$subCategory->title}}</a></div>
                            @endforeach
                        </div>
                    </div>
                ...
                <li class="main-menu join-teachers-li"><a href="become-a-teacher.html">تدریس در سایت</a></li>
